function plotClientPaths(Nodes,Links,sNodes,G)
% plotClientPaths(Nodes,Links,sNodes,G) - Plots the network topology with
%          servers and links in all shortest paths in blue 
%
