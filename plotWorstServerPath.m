function plotWorstServerPath(Nodes,Links,sNodes,G)
% plotWorstServerPath(Nodes,Links,sNodes,G) - Plots the network topology with
%          servers and links in the worst shortest path between servers in blue 
%
...
% G:       graph of the network 
    ...
    hold on
    for i=2:nLinks
        if Links(i,3) == 1  %Links in shortest paths
